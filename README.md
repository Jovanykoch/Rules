...
- Automated build daily at 00:00 UTC
- Automatic build on pushes to `main`
...
- `geosite.dat` / `geosite-cn.dat` / `geosite-gfw.dat`: V2Ray GeoSite data
...
- Clash: Set `rule-providers` to `https://raw.githubusercontent.com/Jovanykoch/rules/rel/reject.yaml`
...
2. Parse and clean rules, including deduplication and parent-domain consolidation
